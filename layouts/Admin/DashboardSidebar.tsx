import { BriefcaseIcon, DocumentTextIcon, HomeIcon, HomeModernIcon } from '@heroicons/react/24/outline'
...
export const DashboardSidebar = () => {
    return (
      <>
        <aside className="z-20 hidden w-64 min-h-screen overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
          <div className="py-4 text-gray-500 dark:text-gray-400">
            ...
            <ul className="mt-6">
              <li className="relative px-6 py-3">
                ...
                <Link className="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="/admin">
            ...
            <ul>
              <li className="relative px-6 py-3">
                <Link className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="/admin/projects">
          ...
          {/* <div  className="fixed inset-0 z-10 flex items-end bg-black bg-opacity-50 md:hidden sm:items-center sm:justify-center" /> */}
