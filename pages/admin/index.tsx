import { Bars3Icon, ChartBarSquareIcon } from '@heroicons/react/24/outline'
        ...
        <DashboardLayout title="Overview" >
            <div>
                ...
                <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                    <StatCard title='Visits' value={1000} icon={<ChartBarSquareIcon className='w-10' />} />
                    <StatCard title='Visits' value={1000} icon={<ChartBarSquareIcon className='w-10' />} />
                    <StatCard title='Visits' value={1000} icon={<ChartBarSquareIcon className='w-10' />} />
                </div>

                <div className="w-full overflow-hidden shadow-xs border">
                    ...
                    {/* <div className="grid px-4 py-3 text-xs font-semibold bg-white tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
